...
export default function SignUp({ navigation }) {
  ...
  // ユーザープールでカスタム属性を追加したらデフォルト属性の email のように扱えばよい

  // ユーザー属性の更新は以下のようにする（以下はただのスニペットです）
  ...
  async function signUp() {
    try {
      await Auth.signUp({
        username,
        password,
        attributes: { email, "custom:themeColor": "defaultColor" },
      });
